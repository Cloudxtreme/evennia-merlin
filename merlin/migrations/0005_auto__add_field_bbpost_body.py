...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BBPost.body'
        db.add_column('merlin_bbpost', 'body', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BBPost.body'
        db.delete_column('merlin_bbpost', 'body')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('merlin_post', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['merlin.Group']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.group'
        db.delete_column('merlin_post', 'group_id')
    ...
    models = {
        ...
        'merlin.post': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['merlin.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
